...
eval_audio_path = "/gpfs/accounts/drmalik_root/drmalik0/mawais/PartialSpoof/eval/con_wav/*.wav"
segment_label_path = "/gpfs/accounts/drmalik_root/drmalik0/mawais/PartialSpoof/database_segment_labels/database/segment_labels/eval_seglab_0.16.npy"
utterance_label_path = "/gpfs/accounts/drmalik_root/drmalik0/mawais/PartialSpoof/protocols/PartialSpoof_LA_cm_protocols/PartialSpoof.LA.cm.eval.trl.txt"
save_path = "/gpfs/accounts/drmalik_root/drmalik0/mawais/PartialSpoof/Specnet/eval/"
...
audio_files = glob(eval_audio_path)
...
for i in range(0, len(features), part_size):
    ...
    part_name = f"{save_path}eval_{'utterance' if extract_utterance_level else 'segment'}_merged_part_{i // part_size + 1}.csv"
